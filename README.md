...
everyone else is holding — but not *what* they're holding.
...
- **Make a bid** — claim a poker hand exists somewhere in *everyone's* combined
  ...
  even a high card.
- **Call bullshit** — you don't buy the last claim. Everyone flips their cards.
...
- **Straights** — you name a rank the straight contains ("a straight with a 6 in
  it"). Any straight covering that rank counts. To raise, name a higher rank.
- **Flushes** — you name the suit and the high card ("ace-high hearts"). Only cards
  at or below that rank count, and the card you named has to actually be there. To
  raise, go *lower* — a queen-high flush is harder to make than an ace-high one.
- **Straight flushes** — same idea as straights, but all one suit.

### Jokers

Optional, 0–2 of them. A joker is a wildcard — when the cards come up, it becomes
whatever card the claim needs. Two real 9s and a joker? That's three 9s.
...
There's also an experimental "opponent modelling" toggle — bots trying to read
